...
public class WordMeaningRequest_br implements WordMeaningRequest {
            ...
            Gdx.net.sendHttpRequest(request, new Net.HttpResponseListener() {
                ...
                public void handleHttpResponse(final Net.HttpResponse httpResponse) {
                    ...
                    Gdx.app.postRunnable(new Runnable() {
                        @Override
                        public void run() {
                            WordMeaningRequest_br.this.callback.onMeaning(WordMeaningRequest_br.this.word, responseToSend);
                        }
                    });
                ...
                public void failed(Throwable t) {
                    ...
                    Gdx.app.postRunnable(new Runnable() {
                        @Override
                        public void run() {
                            WordMeaningRequest_br.this.callback.onMeaning(WordMeaningRequest_br.this.word, text);
                        }
                    });
                }
